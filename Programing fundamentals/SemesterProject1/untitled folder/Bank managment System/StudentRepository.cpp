...
int main()
{
    ...
    do
    {
        ...
        {
            // Convert the userInput to an integer if it's a digit
...
void addStudent()
{
    ...
    if (numStudents < MAX_STUDENTS)
    {
        ...
        {
            while (students[i].name == students[numStudents].name)
            {
        ...
        for (int i = 0; i < numStudents; i++)
        {
            while (students[i].SapID == students[numStudents].SapID)
            {
                cout << "Enter student Sap ID: ";
